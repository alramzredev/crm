...
return new class extends Migration
{
    ...
    {
        Schema::create('staging_units', function (Blueprint $table) {
            ...
            // Unit identification
            $table->char('unit_uuid', 36)->nullable();
            ...
            $table->index('import_batch_id', 'idx_staging_units_batch');
            $table->index('import_status', 'idx_staging_units_status');
            $table->index('unit_code', 'idx_staging_units_code');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('staging_units');
    }
};
