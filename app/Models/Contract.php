...
class Contract extends Model implements HasMedia
{
    ...
    // Register media collections for original and signed contracts
    public function registerMediaCollections(): void
    {
        $this->addMediaCollection('original_contract')->singleFile();
        $this->addMediaCollection('signed_contract')->singleFile();
    }
    ...
    {
        return [
            'original' => $this->getFirstMedia('original_contract'),
            'signed' => $this->getFirstMedia('signed_contract'),
        ];
    }
}
